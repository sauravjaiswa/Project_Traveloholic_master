...
public class WeatherActivity extends AppCompatActivity {
    ...
    String CITY="chandigarh,ind";
    String API = "YOUR_KEY_HERE";
    Geocoder geocoder;
    ...
    private LocationCallback mLocationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            latitude=Double.parseDouble(df.format(mLastLocation.getLatitude()));
            longitude=Double.parseDouble(df.format(mLastLocation.getLongitude()));
        }
    };
