package com.example.traveloholic.ui.Hotels;
...
public class hotels extends Fragment implements OnMapReadyCallback, PopupMenu.OnMenuItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        list.setText("Show List Of Hotels");
...
//        Log.e("Data",dataTransfer[1].toString());
        ...
        Toast.makeText(getContext(),"Showing nearby Hotels",Toast.LENGTH_SHORT).show();
