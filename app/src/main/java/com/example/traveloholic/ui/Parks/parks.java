package com.example.traveloholic.ui.Parks;
...
public class parks extends Fragment implements OnMapReadyCallback{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        list.setText("Show List Of Amusement Parks");
...
//        Log.e("Data",dataTransfer[1].toString());
        ...
        Toast.makeText(getContext(),"Showing nearby parks",Toast.LENGTH_SHORT).show();
